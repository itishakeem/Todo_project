...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   **HOW TO WRITE CHECKLIST ITEMS - "Unit Tests for English"**:
   ...
   - "Are loading state requirements defined for asynchronous episode data?" [Completeness]
...
- "Is the fallback behavior defined when images fail to load? [Edge Case, Gap]"
